...
/// </summary>
public enum SEJoystickAxis { none, Both, Horizontal, Vertical}

public class SIJoystick : MonoBehaviour, IPointerUpHandler, IPointerDownHandler
{
    ...
    [SerializeField] SEJoystickAxis joystickAxis;
    ...
    void Update()
    {
        if (Pressed)
        {
            ...
            //Handle.anchoredPosition = (InputVector / 2f) * HandleRange;
            Horizontal = AxisNormalized.x;
            Vertical = AxisNormalized.y;
        }
    }
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if(joystickAxis == SEJoystickAxis.Both)
        {
